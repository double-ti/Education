...
2. The query uses an index to determine which documents match.
3. The query returns 251120 documents.
4. The query examines 251120 documents.
5. The query is a covered query.
